...
const ComputeCluster = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section id="hero" className="relative min-h-screen overflow-hidden bg-[#f7fafc] text-slate-950">
        ...
        <div className="container relative mx-auto flex min-h-screen max-w-7xl items-center px-6 pb-14 pt-28 md:px-12 lg:px-20">
          <div className="max-w-2xl">
            ...
            {/* Title */}
            <h1 className="mb-4 text-4xl font-heading font-bold leading-tight tracking-tight text-slate-950 md:text-5xl lg:text-6xl">
              Kaiser I
            </h1>

            {/* Funding Logo */}
            <div className="mb-6 max-w-[280px] rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
              <img
            ...
            <div className="flex flex-wrap items-center gap-4">
              <a
                ...
                className="inline-flex items-center gap-2 rounded-full bg-slate-950 px-6 py-3 text-sm font-bold text-white shadow-lg transition-all duration-200 hover:bg-primary-700 hover:scale-[1.02] active:scale-[0.98]"
              >
              ...
              <a
                href="#capabilities"
                className="inline-flex items-center gap-2 rounded-full border border-slate-300 bg-white px-6 py-3 text-sm font-bold text-slate-700 shadow-sm transition-all duration-200 hover:border-primary-300 hover:text-primary-700 hover:scale-[1.02] active:scale-[0.98]"
              >
            ...
            <div className="mt-12 grid grid-cols-2 gap-3 sm:grid-cols-4">
              {clusterStats.map((s) => {
                const Icon = s.icon
                return (
                  <div key={s.label} className="rounded-xl border border-slate-200 bg-white/90 p-4 shadow-sm backdrop-blur">
                    <Icon className="mb-2 h-4 w-4 text-primary-600" aria-hidden="true" />
                    <p className="text-2xl font-bold text-slate-950">{s.value}</p>
                    <p className="text-xs font-semibold text-slate-700 leading-5">{t(s.label)}</p>
                    <p className="mt-0.5 text-xs text-slate-400">{t(s.description)}</p>
                  </div>
                )
              })}
            </div>
      ...
      {/* ── Purpose ── */}
      <section id="purpose" className="border-t border-slate-100 bg-white py-16 md:py-24">
        <div className="container mx-auto max-w-6xl px-6 md:px-12 lg:px-20">
          <div className="grid gap-12 md:grid-cols-2 md:items-center">
            <div>
              ...
              <h2 className="mb-5 text-3xl font-heading font-bold leading-tight tracking-tight text-slate-950 md:text-4xl">
            ...
            <div className="flex flex-col gap-6">
              <div className="overflow-hidden rounded-2xl border border-slate-200 bg-slate-50 shadow-sm">
                <img
                  ...
                  loading="lazy"
                />
                <div className="p-4 text-xs font-semibold text-slate-500 leading-normal text-center bg-white border-t border-slate-100">
                  {pick(
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={text} className="flex items-start gap-3">
                    ...
                    <p className="text-sm leading-6 text-slate-700">{t(text)}</p>
                  </div>
                ))}
              </div>
            </div>
      ...
      {/* ── Capabilities ── */}
      <section id="capabilities" className="border-t border-slate-100 bg-slate-50 py-16 md:py-24">
        <div className="container mx-auto max-w-6xl px-6 md:px-12 lg:px-20">
          <div className="mb-12 max-w-2xl">
            <p className="mb-3 text-xs font-bold uppercase tracking-[0.22em] text-primary-700">{pick('Hardware & Nodes', 'Hardware & Knoten')}</p>
            <h2 className="text-3xl font-heading font-bold leading-tight tracking-tight text-slate-950 md:text-4xl">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {capabilities.map((cap) => {
              ...
              return (
                <article
                  key={cap.title}
                  className="group rounded-2xl border border-slate-200 bg-white p-7 shadow-sm transition hover:-translate-y-0.5 hover:border-primary-200 hover:shadow-lg"
                >
                  ...
                  <h3 className="mb-3 text-xl font-bold text-slate-950">{t(cap.title)}</h3>
                  <p className="mb-5 text-sm leading-7 text-slate-600">{t(cap.description)}</p>
      ...
      <section id="sites" className="border-t border-slate-100 bg-white py-16 md:py-24">
        <div className="container mx-auto max-w-6xl px-6 md:px-12 lg:px-20">
          <div className="mb-12 max-w-2xl">
            ...
            {infrastructure.map((site) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="mb-1 text-lg font-bold text-slate-950">{t(site.site)}</h3>
                  <p className="mb-4 text-xs font-semibold uppercase tracking-wide text-slate-400">{t(site.location)}</p>
          ...
          {/* Network diagram row */}
          <div className="mt-8 overflow-hidden rounded-2xl bg-slate-950 text-white shadow-xl">
      ...
      {/* ── Policies ── */}
      <section id="policies" className="border-t border-slate-100 bg-slate-50 py-16 md:py-24">
        <div className="container mx-auto max-w-6xl px-6 md:px-12 lg:px-20">
          <div className="mb-12 max-w-2xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {policies.map((pol) => (
              <div key={pol.title} className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <h3 className="mb-4 text-base font-bold text-slate-950">{t(pol.title)}</h3>
          ...
          <div className="mt-12 rounded-2xl border border-slate-200 bg-gradient-to-br from-white to-slate-50/70 p-8 shadow-md text-center">
            <h3 className="text-xl font-bold text-slate-950 mb-2">{pick('Need detailed usage instructions?', 'Brauchen Sie detaillierte Nutzungshinweise?')}</h3>
