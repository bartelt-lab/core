...
const milestones = [
    ...
    {
        operation: 'Real-world validation',
        title: 'Following a person in the robotics lab',
        summary: 'The leader-following pipeline moves from simulation into a real indoor workspace. The Ridgeback keeps the selected person in view while following them around laboratory equipment, with the perception overlay shown alongside the robot-camera view.',
        outcome: 'The run validates that person detection and mobile following remain connected on the physical Ridgeback in a cluttered lab setting.',
        facts: [
            { label: 'Platform', value: 'Physical Ridgeback' },
            { label: 'Environment', value: 'Robotics laboratory' },
            { label: 'Target', value: 'Selected person' },
            { label: 'Feedback', value: 'Live detection overlay' },
            { label: 'Task', value: 'Indoor leader following' },
        ],
        media: {
            type: 'video',
    ...
    {
        operation: 'Extended indoor route',
        title: 'Sustained following through a corridor',
        summary: 'The second real-world milestone takes the Ridgeback out of the open lab and along a narrower route. The robot follows the designated person through a doorway and down a corridor while the inset perception view continues to localize the leader.',
        outcome: 'The longer run demonstrates continuous target tracking and robot motion across changing room geometry and a constrained hallway.',
        facts: [
            { label: 'Platform', value: 'Physical Ridgeback' },
            { label: 'Route', value: 'Room to corridor' },
            { label: 'Target', value: 'Designated leader' },
            { label: 'Feedback', value: 'Live detection overlay' },
            { label: 'Focus', value: 'Tracking continuity' },
        ],
        media: {
            type: 'video',
