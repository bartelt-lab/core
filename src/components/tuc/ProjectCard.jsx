...
const ProjectCard = ({ project }) => {
    ...
    const getStatusColor = (status) => {
        switch (status.toLowerCase()) {
            ...
            case 'scouting': return 'bg-primary-100 text-primary-800 border-primary-200';
    ...
    const CardContent = () => (
        <>
            ...
            <div className="absolute inset-0 rounded-2xl border-2 border-transparent group-hover:border-primary-500/20 transition-colors duration-300 pointer-events-none z-20"></div>
            ...
            <div className="relative aspect-[16/9] overflow-hidden bg-gray-100">
                ...
                {project.youtubeId ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center bg-gray-800/50 text-gray-600">
                        ...
                        <div className="absolute inset-0 opacity-20 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-primary-400 via-gray-900 to-black"></div>
